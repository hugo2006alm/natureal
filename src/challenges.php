...
if (isset($_GET['erro'])){
    if ($_GET['erro']==1){
        ...
        <div role="alert" class="alert alert-error max-w-xs">
...
?>
    ...
    <div class="mt-4">
        <form class="w-96 flex flex-col justify-center items-center [&>*]:mb-3 last:mb-0" action="posts/trata_post.php" method="post" enctype="multipart/form-data">
            ...
            <textarea name="descricao" class="textarea textarea-bordered w-full max-w-xs resize-none" placeholder="Descrição"></textarea>

            <input type="file" class="file-input file-input-bordered file-input-primary w-full max-w-xs" name="foto" required>

            <button type="submit" class="btn btn-circle btn-primary text-base-100">
